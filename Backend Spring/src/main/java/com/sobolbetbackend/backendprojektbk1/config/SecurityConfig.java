    ...
    public SecurityFilterChain SecurityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST,"/linemaker/**").permitAll()
                        .requestMatchers(HttpMethod.PATCH,"/linemaker/**").permitAll()
                        .requestMatchers(HttpMethod.DELETE,"/linemaker/**").permitAll()
